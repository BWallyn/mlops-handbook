...
* A **conf/** directory, which contains all the parameters of each pipeline, global parameters shared by several or all pipelines and the catalog, which contains all the datasets, figures, etc. to save to a file and to share between the pipelines.
